export const SpotifyLogo = ({ className }) => (
  <svg viewBox="0 0 1134 340" className={className}>
    <title>Spotify</title>
    <path
      fill="currentColor"
...
export const HeartHightlightIcon = ({
  width = "1.6rem",
  height = "1.6rem",
  className,
  viewBox = "0 0 16 16",
